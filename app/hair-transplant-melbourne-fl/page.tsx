      ...
      <section className="sec" id="location">
        <div className="wrap g2" style={{ alignItems: "start" }}>
          ...
          <div>
            ...
            >
              View our Google listing, directions and reviews &rarr;
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="sec sec--tint" id="contact">
        ...
        <div className="wrap g2 g2--stretch contact-grid">
          <div className="contact-copy">
            ...
            {/* The photo is absolutely positioned inside this box so its own
                height never sizes the row; the box takes whatever height the
                form column sets and the photo fills it. */}
